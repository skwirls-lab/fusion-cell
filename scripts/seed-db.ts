...
import { createDb, schema } from '../src/lib/db/index';
...
const counts = (await h.db.execute<{ t: string; n: number }>(sql`
...
console.table(Object.fromEntries(counts.map((c) => [c.t, c.n])));
